...
echo "######################################################"
echo "This Script is used to trigger an event that is captured in your S3 Bucket using AWS Lambda Functions to your E-Mail Address via an SNS Topic Subscriptipon."
...
aws sns publish \
  ...
  --message "Kindly check the latest uploads available in your S3 Bucket, Enjoy!"
