...
echo "######################################################"
echo "This Script is used to trigger an event that is captured in your S3 Bucket using AWS Lambda Functions to your E-Mail Address via an SNS Topic Subscription."
echo "Author : Hemkumar S"
echo "Version: V1"
date
echo "######################################################"
set -x
...
bucket_name="hemkumar-s3-bucket"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="hemkumar.s.1998@gmail.com"
...
aws sns publish \
  ...
  --message "A new Object is uploaded onto your S3 Bucket, Dont forget to check it out. ENJOY!"
